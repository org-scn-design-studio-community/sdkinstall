// requestChangeLog("../../../sdkhelp/web/10/components/basics/accordion/changes/changelog.json");
var model = {};
var globalChangeLog = [];
...
itemFactory = function(sId, sModel) {
    ...
    var link = "https://github.com/org-scn-design-studio-community/sdkhelp/tree/master/web/10/components/" + sItem.compId.replace("_", "/");
